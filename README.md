...
[体验手机端原型](原型设计/index.html) · [完整 PRD](听荐_PRD.pdf) · [需求分析概述](需求分析概述.pdf)
...
完整测试设计见 [MVP验证计划](docs/evaluation-plan.md)。

## 用户需求调研

项目已发布匿名需求问卷，面向过去一年内购买或认真比较过无线耳机的用户。问卷先了解真实选购流程和痛点，再介绍产品概念并收集功能偏好。

- [参与《听荐》无线耳机用户需求调研](https://v.wjx.cn/vm/hNEC0N6.aspx)
- [查看问卷文本](research/听荐_无线耳机用户需求调研_问卷星文本导入版.txt)
- 不收集姓名、手机号、学校或公司名称

当前仍处于答卷回收和探索性验证阶段，尚不宣称已经证明市场需求。
...
1. 使用真实模型复测20条需求和30份引用报告，记录成功率、降级率和引用错误；
2. 人工复核至少30条主题/倾向标签，记录规则误判并迭代标注方法；
3. 邀请3–5名用户完成探索性任务测试；
4. 在确认数据展示边界后完成国内公开部署和60–90秒演示视频。
